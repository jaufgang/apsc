# APSC Volunteer Work Management System

## Project Overview

**Purpose**: A web application for Aquatic Park Sailing Club to manage volunteer work obligations, allowing members to find and sign up for jobs, log ad-hoc volunteer hours, and track progress toward their annual work requirements.

**Target Users**:
- Club members (volunteer workers)
- Committee leads (post jobs for their areas)
- Administrators (manage system, approve hours, generate reports)
